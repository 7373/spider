...
//            System.out.println(textField);
            ...
            textField.setValueAttribute("王子诚");
            // 输入好了，我们点一下这个按钮
...
//            username.setAttribute(attributeName, attributeValue);
            username.type("wzc6426");
            HtmlInput password = (HtmlInput) page.getElementById("password");
            password.type("ran888");
